...
class Scoreboard:
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(f"HS {high_score_str}", True, self.text_color, self.settings.bg_color)
    ...
    def show_score(self):
        """Draw the scores, level and ships left on the screen."""
